/****************************************************************************
** Meta object code from reading C++ file 'wykres.hh'
**
...
#include "../../inc/wykres.hh"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'wykres.hh' doesn't include <QObject>."
...
static const char qt_meta_stringdata_Wykres[] = {
    "Wykres\0\0qv_x,qv_enc\0"
    "plot(QVector<double>,QVector<double>)\0"
};
...
void Wykres::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->plot((*reinterpret_cast< QVector<double>(*)>(_a[1])),(*reinterpret_cast< QVector<double>(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
const QMetaObject Wykres::staticMetaObject = {
    { &QCustomPlot::staticMetaObject, qt_meta_stringdata_Wykres,
