/****************************************************************************
** Meta object code from reading C++ file 'info.hh'
**
...
#error "The header file 'info.hh' doesn't include <QObject>."
...
void Info::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->showText((*reinterpret_cast< const int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject Info::staticMetaObject = {
    { &QMessageBox::staticMetaObject, qt_meta_stringdata_Info,
